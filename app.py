...
st.markdown("Вставь **весь сырой JSON-ответ** из терминала → приложение вытащит чистый код и отрендерит графики.")
...
if st.button("Обработать и показать"):
    if raw_json.strip():
        try:
            ...
            # Убираем ВСЁ после инструкций, комментариев, """ и т.д.
